...
public class ServerTest_execute_reverse {

	private static String serverMonitorIniFile = "files/testcases/webflow/inifiles/w4a.monitor.ini";
	private static String webflowIniFile = "files/testcases/reverse_switched/freeformjs.webflow (1).zip";
	...
	private static String zippedFile = "files/testcases/reverse_switched/src.zip";

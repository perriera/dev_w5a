...
public class ServerTest_ReverseUploadRequest {
	...
	public void setUp() throws Exception {
		...
		ServerTest_ReverseUploadRequest.webflowFile = ServerTest_ReverseUploadRequest._webflowFile; 
		ServerTest_ReverseUploadRequest.zippedFile = ServerTest_ReverseUploadRequest._zippedFile; 
		...
		webflowFile = server.uploadAndTagZipFileToServer(webflowFile,token, UserRequest.REVERSE);
		zippedFile = server.uploadAndTagZipFileToServer(zippedFile,token, UserRequest.REVERSE);
	...
	@Test
	public void test_parseUploaded_zippedFile() throws Exception {
		...
		url.parseUploaded(new File(zippedFile));

...
public class ServerTest_PartialUploadRequest {
	...
	public void setUp() throws Exception {
		...
		ServerTest_PartialUploadRequest.webflowFile = ServerTest_PartialUploadRequest._webflowFile; 
		ServerTest_PartialUploadRequest.zippedFile = ServerTest_PartialUploadRequest._zippedFile; 
	...
	public void test_02_monitor_uploads_directory_with_forward_example() throws Exception {
		...
		String partialFilename = "F-ER2343_"+"c-org.webflow.zip.part1";
		server.uploadZipFileToServer(webflowFile, partialFilename);
		Assert.assertTrue(server.existsInUploads(partialFilename));

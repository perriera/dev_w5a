...
public class NgTestSetupB extends MockProjectSetup {
	...
	public static String getSoureFilename() {
		return "files/formaltests/ngexternal/freeformjs.webflow.ng-external.zip";
	}

...
public class NgImport implements ObjectCompilerInterface<String>, SourceKeyPathInterface, Comparable<NgImport> {
	...
	public NgImport(String text, W2AIniFile iniFile) throws Exception {
	...
	@Override
	public int compareTo(NgImport other) {

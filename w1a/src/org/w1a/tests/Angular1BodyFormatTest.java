...
public class Angular1BodyFormatTest extends Setup {

	public static String testFilename = "angular1.bodytest.ini";
	...
	public void testAngular1Formatter() throws Exception {
		...
		extractor.input();
		Angular1BodyFormat archiver = new Angular1BodyFormat(extractor);
